...
<style>
	...
	ul.my-pagination{
	list-style-type:none; /*ul의 disc 없애기 (세로배치)*/
	padding-left:0;
	display:flex; /*자식요소 (li) flex 레이아웃으로 배치 (가로배치)*/
	gap:10px;
	justify-content:center; /*가로로 정렬된 상태에서 중앙 정렬*/
	}
...
<jsp:include page="/WEB-INF/include/navbar.jsp">
	...
	<h1>게시글 목록입니다</h1>
	<a class ="btn btn-outline-primary btn-sm" href="new-form.jsp">새글 작성
